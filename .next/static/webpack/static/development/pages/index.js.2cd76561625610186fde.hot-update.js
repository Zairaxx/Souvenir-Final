...
})(["background-image:linear-gradient(to left,#003A3E,#141E30);display:", ";position:", ";flex-direction:", ";align-items:", ";justify-content:", ";width:", ";top:", ";min-height:100vh;min-width:", ";left:", ";right:", ";overflow-x:hidden;overflow-y:", ";z-index:", ";padding:", ";"], function (props) {
  return props.display || "flex";
}, function (props) {
  return props.position || "auto";
}, function (props) {
...
})(["display:", ";width:13px;height:13px;background-image:linear-gradient(to left,#003A3E,#141E30);border:1px solid black;margin-left:5px;border-radius:3px;cursor:", ";&:hover{border:", ";}"], function (props) {
  return props.display || "flex";
}, function (props) {
...
//# sourceMappingURL=index.js.2cd76561625610186fde.hot-update.js.map